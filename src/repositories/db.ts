...
import {BlogType, CommentDBType, PostType, TokenDBType, UserDbType} from "./types";
...
export const revokedTokensCollection = db.collection<TokenDBType>("revokedTokensCollection");
